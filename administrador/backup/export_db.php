...
require'../php/conexion.php';
	...
	//	header("Content-Disposition: attachment; filename=$archivosql"); 
			...
			$fecha=date('Y-m-d g:i:s-a');
						...
						if ($resultado) { 
								echo '<script language="JavaScript">alert("Respaldo Fallido"); window.location="../respaldarbasededatos.php";</script>';
							...
							mysqli_query($conexion, $auditoria);
								...
								echo '<script language="JavaScript">alert("Respaldo Exitoso"); window.location="../respaldarbasededatos.php";</script>';
