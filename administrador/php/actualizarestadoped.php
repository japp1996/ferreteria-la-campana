<?php 
  ...
  if (isset($_POST['actualizar'])) {
    ...
    mysqli_query($conexion,$sql);
      ...
      $auditoria="INSERT INTO auditoria_usuarios(CI_RIF,OPERACION,DETALLES_OPERACION,FECHA) VALUES('".$_SESSION['CI_RIF']."','Modificacion','Modificacion de Estado de pedido','$fecha')";
