...
if ($status==$cancelado) {
     ...
     while ($fetch= mysqli_fetch_assoc($query)) {
        $update="UPDATE productos SET EXISTENCIA_PRODUCTO=(EXISTENCIA_PRODUCTO+".$fetch['CANTIDAD_PRODUCTO'].") WHERE ID_PRODUCTO='".$fetch['ID_PRODUCTO']."'";
     ...
     mysqli_query($conexion, $cambiostat);
            ...
            $auditoria="INSERT INTO auditoria_usuarios(ID_AUDITORIA,CI_RIF,OPERACION,DETALLES_OPERACION,FECHA) VALUES('','".$_SESSION['CI_RIF']."','Modificacion','Anulacion de Pedido','$fecha')";
...
elseif ($status==$entregado) {
        ...
        $update="UPDATE pedidos SET ID_ESTADO='$status' WHERE ID_PEDIDO='$noped'";
         ...
         mysqli_query($conexion, $update);
          ...
          $fecha=date('Y-m-d g:i:s-a');
    $auditoria="INSERT INTO auditoria_usuarios(ID_AUDITORIA,CI_RIF,OPERACION,DETALLES_OPERACION,FECHA) VALUES('','".$_SESSION['CI_RIF']."','Modificacion','Pedido Entregado','$fecha')";
    mysqli_query($conexion, $auditoria);
    ...
    $fecha=date('Y-m-d g:i:s-a');
    $auditoria="INSERT INTO auditoria_usuarios(ID_AUDITORIA,CI_RIF,OPERACION,DETALLES_OPERACION,FECHA) VALUES('','".$_SESSION['CI_RIF']."','Modificacion','Procesamiento de estado de pedido','$fecha')";
    mysqli_query($conexion, $auditoria);
