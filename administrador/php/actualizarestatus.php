...
include "conexion.php";
   ...
   if ($status == $cancelado) {
      ...
      $auditoria="INSERT INTO auditoria_usuarios(CI_RIF,OPERACION,DETALLES_OPERACION,FECHA) VALUES('".$_SESSION['CI_RIF']."','Modificacion','Anulacion de Pedido','$fecha')";
      ...
      mysqli_query($conexion, $update);
      $fecha=date('Y-m-d g:i:s-a');
      $auditoria="INSERT INTO auditoria_usuarios(CI_RIF,OPERACION,DETALLES_OPERACION,FECHA) VALUES('".$_SESSION['CI_RIF']."','Modificacion','Pedido Entregado','$fecha')";
      mysqli_query($conexion, $auditoria);
      ...
      $fecha=date('Y-m-d g:i:s-a');
      $auditoria="INSERT INTO auditoria_usuarios(CI_RIF,OPERACION,DETALLES_OPERACION,FECHA) VALUES('".$_SESSION['CI_RIF']."','Modificacion','Procesamiento de estado de pedido','$fecha')";
      mysqli_query($conexion, $auditoria);
