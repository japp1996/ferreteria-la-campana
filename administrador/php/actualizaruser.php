    ...
    //SINO MOSTRAR ALERTA
        ...
        if (isset($_POST['actualizar'])) {
           ...
           echo '<br><div class="alert">
            ...
            $auditoria="INSERT INTO auditoria_usuarios(ID_AUDITORIA,CI_RIF,OPERACION,DETALLES_OPERACION,FECHA) VALUES('','".$_SESSION['CI_RIF']."','Modificacion','Modificacion de datos de usuario','$fecha')";
        ...
        if (isset($_POST['eliminar'])) {
             $cedulael=$_POST['cedulaver'];
                    ...
                    $fecha=date('Y-m-d g:i:s-a');
                    $auditoria="INSERT INTO auditoria_usuarios(ID_AUDITORIA,CI_RIF,OPERACION,DETALLES_OPERACION,FECHA) VALUES('','".$_SESSION['CI_RIF']."','Eliminacion','Eliminacion de usuario','$fecha')";
                    mysqli_query($conexion, $auditoria);
