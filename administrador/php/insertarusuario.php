                              ...
                              if ($contrasena==$repcontrasena) {
                                if(filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)){
                                  if (strlen($email) <= 64) {
                                    ...
                                    $auditoria="INSERT INTO auditoria_usuarios(ID_AUDITORIA,CI_RIF,OPERACION,DETALLES_OPERACION,FECHA) VALUES('','".$_SESSION['CEDULA']."','Registro','Registro de usuario','$fecha')";
