...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3><p align="center">ACTUALIZAR PEDIDO</p></h3>
                <form action="" method="POST" class="datagrid">
                    <table>
                        ...
                        <?php
                        $sql="SELECT * FROM pedidos inner join usuarios on pedidos.CI_RIF=usuarios.CI_RIF WHERE pedidos.CI_RIF='".$_SESSION['CI_RIF']."' order by pedidos.ID_PEDIDO ASC";
                        $consulta=mysqli_query($conexion,$sql);

                        while($resgistros=mysqli_fetch_array($consulta)) {
                            echo'<tr>
                            <td class="noped"><a href="actdetallespedido.php?id='.$resgistros["ID_PEDIDO"].'">'.$resgistros["ID_PEDIDO"].'</a></td>
