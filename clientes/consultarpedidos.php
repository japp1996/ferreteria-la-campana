...
<body>
    ...
    INNER JOIN usuarios ON pedidos.CI_RIF=usuarios.CI_RIF 
    WHERE pedidos.CI_RIF='".$_SESSION['CEDULA']."' order by ID_PEDIDO ASC";
                ...
                <div class="datagrid">
                    <table>
                        ...
                        while($resgistros=mysqli_fetch_array($consulta)) {
                            ...
                            <td class="noped">'.$_SESSION['NOMBRE_USUARIOS'].'</td>
