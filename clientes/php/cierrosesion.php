...
if(isset($_GET['modo']) == 'desconectar')
                    {
                        ...
                        $auditoria="INSERT INTO auditoria_usuarios(ID_AUDITORIA,CI_RIF,OPERACION,DETALLES_OPERACION,FECHA)VALUES('','".$_SESSION['CEDULA']."','Salida','Salida del Sistema','$fecha')";
