...
if (isset($_POST['registrarcat'])) {
  ...
  if ($fila2==1) {
    ...
    $auditoria="INSERT INTO auditoria_usuarios(ID_AUDITORIA,CI_RIF,OPERACION,DETALLES_OPERACION,FECHA) VALUES('','".$_SESSION['CEDULA']."','Registro','Registro de categoria','$fecha')";
