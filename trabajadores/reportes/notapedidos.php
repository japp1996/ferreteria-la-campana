...
$consulta="SELECT usuarios.NOMBRE_USUARIOS, pedidos.CI_RIF, pedidos.FECHA_PEDIDO 
				FROM usuarios 
					INNER JOIN pedidos 
...
$sql="SELECT productos.ID_PRODUCTO, productos.DESCRIPCION_PRODUCTO, detalles_pedido.CANTIDAD_PRODUCTO, detalles_pedido.ID_PEDIDO 
		FROM productos 
			INNER JOIN detalles_pedido ON productos.ID_PRODUCTO = detalles_pedido.ID_PRODUCTO 
